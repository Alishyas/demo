...
class AddProduct extends Component {
    ...
    handleSubmit(evt) {
        ...
        let self = this;
        axios.post('http://localhost:8080/createproduct', payload)
            .then(res => {
                this.setState({
                    show: true,
                });
        ...
        return (
            <div className="wrapper">
                <form className="form-signin" onSubmit={this.handleSubmit}>
                    ...
                    <br />
                     <textarea className="form-control" value={this.state.desciption} name="description" placeholder="Description" autoFocus onChange={this.handleDescription} />
                    <br />

                    <input type="submit" value="Add Product" data-test="submit" className="btn btn-lg btn-primary btn-block" />
                    <br />
